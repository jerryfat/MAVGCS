...
MavVars.ConnectTo = 2  # connectTo an SITL or autopilot; 1=startup and use internal sitl, takes longer, 2=connect vehicle using ip addr of sitl , 3=connect using serial port
